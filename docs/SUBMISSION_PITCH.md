...
Status: Design proposal. This pitch covers Phase 1 only. Phase 2 and Phase 3 roadmap items are intentionally excluded — see `docs/RESCOPE_REVIEW.md` and the project's phase roadmap for what comes later, none of which belongs in this pitch.
...
- Synthetic merchant-week data generator (5-state latent simulation).
...
- Streamlit dashboard: merchant-week feed, case detail, appeal view, audit timeline, and held-out metrics with a rules-only vs. rules+ML comparison.
